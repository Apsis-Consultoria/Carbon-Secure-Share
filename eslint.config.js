  ...
  },
  {
    ...
    languageOptions: {
      globals: {
         ...
         * lida por src/lib/endpoint.js. O Rollup a substitui pelo literal antes
         * de o codigo existir, entao nao e variavel de ambiente do navegador.
         * Sem esta linha o no-undef acusa, e desligar a regra no arquivo
